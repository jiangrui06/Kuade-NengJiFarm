(function (window) {
	...
	window.FarmAPI = {
		...
		user: {
			...
			detailById: function (userId) { return request('/api/back-user/' + encodeURIComponent(userId)); },
			disable: function (id) { return put('/api/back-user/' + encodeURIComponent(id) + '/disable'); },
			enable: function (id) { return put('/api/back-user/' + encodeURIComponent(id) + '/enable'); },
			...
			resetPassword: function (data) { return post('/api/back-user/reset-password', data); }
			},
		points: {
			goods: {
